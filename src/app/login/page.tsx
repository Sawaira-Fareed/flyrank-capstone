      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 flex items-center justify-center lg:justify-start gap-6 lg:gap-12">
        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="font-heading text-3xl font-bold text-[#4C1D95] mt-4 text-center">Bloom in your Garden.</h2>
            <p className="text-sm text-[#6B7280] text-center mt-2 max-w-[280px]">Let's continue growing your coding journey together.</p>
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }}
          ...
          <div className="text-center mb-2">
            ...
            <h1 className="font-heading text-2xl font-bold bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] bg-clip-text text-transparent">BloomLab</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Email"
                className={`w-full h-[54px] rounded-full border bg-white/55 backdrop-blur px-5 text-sm text-[#312E81] outline-none placeholder:text-[#6B7280]/60 transition ${errors.email ? "border-red-400" : "border-white/50 focus:border-[#C084FC] focus:ring-2 focus:ring-[#C084FC]/30"}`} />
              {errors.email && <p className="mt-1 ml-4 text-xs text-red-500">{errors.email}</p>}
            </div>
            <div>
              <div className="relative">
                <input type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Password"
                  className={`w-full h-[54px] rounded-full border bg-white/55 backdrop-blur px-5 pr-12 text-sm text-[#312E81] outline-none placeholder:text-[#6B7280]/60 transition ${errors.password ? "border-red-400" : "border-white/50 focus:border-[#C084FC] focus:ring-2 focus:ring-[#C084FC]/30"}`} />
          ...
          <p className="text-center text-sm text-[#6B7280] mt-6">
            ...
            <Link href="/signup" className="font-semibold bg-gradient-to-r from-[#8B5CF6] to-[#EC4899] bg-clip-text text-transparent hover:underline">Create Account</Link>
          </p>
        </motion.div>
      </div>
    </div>
